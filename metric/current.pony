...
class val Current is Metric
  ...
  fun val to_kA():Current =>
    match _unit
    | "A" => unit_kA(_val * 1E-3)
    | "mA" => unit_kA(_val * 1E-6)
    | "µA" => unit_kA(_val * 1E-9)
    | "nA" => unit_kA(_val * 1E-12)
    | "pA" => unit_kA(_val * 1E-15)
    | "kA" => this
    else this
    end
  ...
  fun val to_mA():Current =>
    ...
    | "A" => unit_mA(_val * 1E3)
    | "mA" => this
    | "µA" => unit_mA(_val * 1E-3)
    | "nA" => unit_mA(_val * 1E-6)
    | "pA" => unit_mA(_val * 1E-9)
    | "kA" => unit_mA(_val * 1E6)
    else this
    end
  ...
  fun val to_uA():Current =>
    ...
    | "mA" => unit_uA(_val * 1E3)
    | "µA" => this
    | "nA" => unit_uA(_val * 1E-3)
    | "pA" => unit_uA(_val * 1E-6)
    | "kA" => unit_uA(_val * 1E9)
    else this
    end
  ...
  fun val to_nA():Current =>
    ...
    | "µA" => unit_nA(_val * 1E3)
    | "nA" => this
    | "pA" => unit_nA(_val * 1E-3)
    | "kA" => unit_nA(_val * 1E12)
    else this
    end
