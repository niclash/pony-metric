...
class val Pressure is Metric
  ...
  fun val to_Pa():Pressure =>
    match _unit
    | "Pa" => this
    | "mPa" => unit_Pa(_val / 1000)
    | "kPa" => unit_Pa(_val * 1000)
    | "MPa" => unit_Pa(_val * 1000000)
    else this
    end

  fun val to_milli_Pa():Pressure =>
    match _unit
    | "Pa" => unit_milli_Pa(_val * 1000)
    | "mPa" => this
    | "kPa" => unit_milli_Pa(_val * 1000000)
    | "MPa" => unit_milli_Pa(_val * 1000000000)
    else this
    end

  fun val to_kPa():Pressure =>
    match _unit
    | "Pa" => unit_kPa(_val / 1000)
    | "mPa" => unit_kPa(_val / 1000000)
    | "kPa" => this
    | "MPa" => unit_kPa(_val * 1000)
    else this
    end

  fun val to_MPa():Pressure =>
    match _unit
    | "Pa" => unit_kPa(_val / 1000000)
    | "mPa" => unit_MPa(_val / 1000000000)
    | "kPa" => unit_MPa(_val / 1000)
    | "MPa" => this
    else this
    end
